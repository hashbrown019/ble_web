...
function dhm(ms) {
	...
	if(_int(minutes)!=0){mins_= minutes+" minute ago"}
	if(_int(minutes)>1){mins_= minutes+" minutes ago"}
	else{mins_="Just Now"}

	if(_int(hours)!=0){hrs_= hours+" hour ago";mins_=""}
	if(_int(hours)>1){hrs_= hours+" hours ago";mins_=""}

	if(_int(days)!=0){days_= days+" Day ago";hrs_=""}
	if(_int(days)>1){days_= days+" days ago";hrs_=""}
	// else{hrs_=""}
